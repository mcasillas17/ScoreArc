      ...
      <main className="main">
        ...
        {groups.length > 0 ? (
          <section id="standings">
            <details className="groups-collapse">
              <summary className="groups-summary">
                <span className="groups-summary-label">Group Stage Results</span>
                <span className="groups-summary-meta">12 groups · tap to expand</span>
                <svg className="groups-chevron" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
