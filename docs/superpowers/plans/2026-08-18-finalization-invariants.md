...
- [ ] **Step 1: Confirm the watermark yourself**
...
- [ ] **Step 2: Re-verify that three of the six tables are written after finalization**
...
- [ ] **Step 3: Re-verify that curation repoints `match_play`**
...
- [ ] **Step 4: Re-verify that `play-backfill` does not write plays**
...
- [ ] **Step 5: Confirm no generated column exists on any of the six tables**
...
- [ ] **Step 2: Verify it parses and applies to an empty database**
...
- [ ] **Step 2: Prove the rollback genuinely reverses**
...
- [ ] **Step 3: Prove the whole reverse chain still runs**
...
- [ ] **Step 1: Add the const and the helper**
...
- [ ] **Step 3: Cascade, player identity, and the escape hatch**
...
- [ ] **Step 4: The error surface, through the real writers**
...
- [ ] **Step 1: The play-stream backlog**
...
- [ ] **Step 2: Curation across sealed records**
...
- [ ] **Step 1: Document the invariant where the schema is described**
...
- [ ] **Step 4: Prove the reverse chain one more time, exactly as CI does it**
