...
- [ ] **Step 1: Capture the tuple counters, twice, across a slow tick**
...
- [ ] **Step 2: Confirm the content is genuinely unchanged across that tick**
...
- [ ] **Step 3: Confirm the migration watermark, so you do not accidentally need one**
...
- [ ] **Step 4: Add the field and initialise it in both constructors**
...
- [ ] **Step 4: Repair the one existing test the guard invalidates**
...
- [ ] **Step 5: Run the whole ingester suite**
...
- [ ] **Step 1: Record the written board in the fake**
...
- [ ] **Step 5: Prove nothing else called them, then run everything**
...
- [ ] **Step 3: Confirm no migration snuck in**
