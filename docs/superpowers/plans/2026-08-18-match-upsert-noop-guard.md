...
- No migration file. No `docs/backend/ARCHITECTURE.md` change — `MatchRow` is an
  internal ingester type, not part of the documented schema or the public API
  contract.
...
- [ ] **Step 1: Add a scheduled-match fixture and the acceptance test**
...
- [ ] **Step 2: Run it and confirm it fails against today's code**
...
- [ ] **Step 3: Branch and commit the failing test**
...
- [ ] **Step 6: Run the whole store package to confirm nothing else broke**
...
- [ ] **Step 3: Implement the guard and its helpers**
...
- [ ] **Step 1: Add the guard between the preservation block and the upsert**
...
- [ ] **Step 2: Run the acceptance test from Task 1**
...
- [ ] **Step 3: Run the full ingester package to confirm no regression**
