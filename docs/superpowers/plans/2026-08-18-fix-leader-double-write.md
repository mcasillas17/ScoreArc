...
- [ ] **Step 2: Run it to verify it fails, and for the stated reason**
...
- [ ] **Step 3: Reorder — mirror before the write, write once**
...
- [ ] **Step 4: Delete the now-dead comparison helpers**
...
- [ ] **Step 6: Run the full existing leader-board suite**
...
- [ ] **Step 1: Backend gate, one more time, from a clean tree**
